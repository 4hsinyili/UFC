lambdas-pre-deploy:
	tee  Lambdas/dispatch_fp_diners/src/.conf Lambdas/dispatch_ue_diners/src/.conf Lambdas/get_fp_detail/src/.conf Lambdas/get_fp_list/src/.conf Lambdas/get_ue_detail/src/.conf Lambdas/get_ue_list/src/.conf Lambdas/log_stepfunction_result/src/.conf < Crawlers/.conf >/dev/null

	tee Lambdas/dispatch_fp_diners/src/conf.py Lambdas/dispatch_ue_diners/src/conf.py Lambdas/get_fp_detail/src/conf.py Lambdas/get_fp_list/src/conf.py Lambdas/get_ue_detail/src/conf.py Lambdas/get_ue_list/src/conf.py Lambdas/log_stepfunction_result/src/conf.py < Crawlers/conf.py >/dev/null
	...
	tee Lambdas/get_ue_list/src/api_ue.json Lambdas/get_ue_detail/src/api_ue.json < Crawlers/api_ue.json >/dev/null
